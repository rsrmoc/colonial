<x-layout.colonial.layout>
    <div class="page-title">
        <h3>Editar REcebimento de Tomate </h3>
                    ...
                    <div class="row">
                        <div class="col-md-2 col-md-offset-1 ">
                            <div class="form-group @if($errors->has('verde')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('verde',str_replace('.', ',', $tomate->verde) )}}" x-mask:dynamic="$money($input, ',')" x-on:input.change="caluculosAnalises()"    placeholder="Verdes" name="verde"> 
                                @if($errors->has('verde'))
                        ...
                        <div class="col-md-2 ">
                            <div class="form-group @if($errors->has('praga')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('praga', str_replace('.', ',', $tomate->praga) )}}" x-mask:dynamic="$money($input, ',')" x-on:input.change="caluculosAnalises()" placeholder="Pragas" name="praga"> 
                                @if($errors->has('praga'))
                        ...
                        <div class="col-md-2 ">
                            <div class="form-group @if($errors->has('fungo')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('fungo', str_replace('.', ',', $tomate->fungo) ) }} "  x-mask:dynamic="$money($input, ',')" x-on:input.change="caluculosAnalises()" placeholder="Fungos" name="fungo"> 
                                @if($errors->has('fungo'))
                        ...
                        <div class="col-md-2 ">
                            <div class="form-group @if($errors->has('desintegrado')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('desintegrado', str_replace('.', ',', $tomate->desintegrado)   )}}" x-mask:dynamic="$money($input, ',')"  x-on:input.change="caluculosAnalises()" placeholder="Desintegrados" name="desintegrado"> 
                    ...
                    <div class="row">
                        <div class="col-md-2 col-md-offset-1 ">
                            <div class="form-group @if($errors->has('defeito')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('defeito', str_replace('.', ',', $tomate->defeito) )}}" x-mask:dynamic="$money($input, ',')"  x-on:input.change="caluculosAnalises()" placeholder="Def. Gerais" name="defeito"> 
                        ...
                        <div class="col-md-2 ">
                            <div class="form-group @if($errors->has('impureza')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('impureza', str_replace('.', ',', $tomate->impureza) )}}"  x-mask:dynamic="$money($input, ',')" x-on:input.change="caluculosAnalises()" placeholder="Impurezas" name="impureza"> 
                        ...
                        <div class="col-md-2 ">
                            <div class="form-group @if($errors->has('terra')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('terra', str_replace('.', ',', $tomate->terra) )}}"  x-mask:dynamic="$money($input, ',')" x-on:input.change="caluculosAnalises()" placeholder="Terra" name="terra"> 
                                @if($errors->has('terra'))
                        ...
                        <div class="col-md-2 ">
                            <div class="form-group @if($errors->has('fruto')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('fruto',str_replace('.', ',',$tomate->fruto) )}}"  x-mask:dynamic="$money($input, ',')" x-on:input.change="caluculosAnalises()" placeholder="Frutos" name="fruto"> 
                                @if($errors->has('fruto'))
                        ...
                        <div class="col-md-2 ">
                            <div class="form-group @if($errors->has('total')) has-error @endif ">
                                <label for="fname">Total(%): <span class="red normal">*</span></label> {{ $tomate->total }}
                    ...
                    <div class="row">
                        <div class="col-md-2 col-md-offset-1 ">
                            <div class="form-group @if($errors->has('brix')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('brix',str_replace('.', ',',$tomate->brix) )}}" x-mask:dynamic="$money($input, ',')" placeholder="Brix" name="brix"> 
                                @if($errors->has('brix'))
                        ...
                        <div class="col-md-2 ">
                            <div class="form-group @if($errors->has('ph')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('ph',str_replace('.', ',',$tomate->ph) )}}" x-mask:dynamic="$money($input, ',')" placeholder="PH" name="ph"> 
                                @if($errors->has('ph'))
                        ...
                        <div class="col-md-2 ">
                            <div class="form-group @if($errors->has('acidez')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('acidez',str_replace('.', ',',$tomate->acidez) )}}" x-mask:dynamic="$money($input, ',')" placeholder="Acidez" name="acidez"> 
                    ...
                    <div class="row">
                        <div class="col-md-2 col-md-offset-1 ">
                            <div class="form-group @if($errors->has('liquido')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('liquido',str_replace('.', ',',$tomate->liquido) )}}" x-mask:dynamic="$money($input, ',')" placeholder="Líquido Balança" name="liquido"> 
                        ...
                        <div class="col-md-2 ">
                            <div class="form-group @if($errors->has('desconto')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('desconto',str_replace('.', ',',$tomate->desconto) )}}" x-mask:dynamic="$money($input, ',')" placeholder="Desconto" name="desconto"> 
