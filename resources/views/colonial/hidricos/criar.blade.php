            ...
            <form action="{{ route('hidrico-store') }}" method="POST" class="panel panel-white">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group @if($errors->has('dt_consumo_anterior')) has-error @endif ">
                                <label for="fname">Data do Consumo Anterior: <span class="red normal">*</span></label>
                                <input type="text" class="form-control " readonly   value="{{old('dt_consumo_anterior')}}" placeholder="Data Consumo " name="dt_consumo_anterior"   />
                                @if($errors->has('dt_consumo_anterior'))
                                    <div class="error">{{ $errors->first('dt_consumo_anterior') }}</div>
                                @endif
                            </div>
                        </div>
