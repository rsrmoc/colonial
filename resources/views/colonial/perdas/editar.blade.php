                            ...
                            <div class="form-group @if($errors->has('ordem')) has-error @endif ">
                                ...
                                <select class="form-control" onchange="carregar(this.value)" name="ordem"  >
                                    ...
                                    @foreach ($ordem as $valor )
                                        <option value="{{ $valor->DocEntry }}" @if(old('ordem',$perda->cd_ordem)== $valor->DocEntry) selected  @endif >{!!   $valor->DocEntry . ' - '. date( 'd/m/Y' , strtotime( $valor->DueDate ) ) .  ' [ '.$valor->ProdName.' ] ' !!}</option> 
                                    @endforeach
                                </select>
                                @if($errors->has('ordem'))
                    ...
                    <div class="row">
                            ...
                            <div class="form-group @if($errors->has('produto')) has-error @endif ">
                                ...
                                <div id="div_combo">
                                    <select class="form-control" name="produto"  >
                                        ...
                                        <option value="{{ $valor->itemcode }}" @if(old('produto',$perda->cd_produto)== $valor->itemcode) selected  @endif  >{!!   $valor->itemcode.' - '.$valor->dscription   !!}</option> 
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group @if($errors->has('tipo')) has-error @endif ">
                                ...
                                <select class="form-control" name="tipo"  >
                                    ...
                                    @foreach ($tipo as $valor )
                                        <option value="{{ $valor->cd_tipo }}" @if(old('tipo',$perda->cd_tipo_perda)== $valor->cd_tipo) selected  @endif >{!!   $valor->nm_tipo   !!}</option> 
                                    @endforeach
                                </select>
                                @if($errors->has('tipo'))
                        ...
                        <div class="col-md-2">
                            <div class="form-group @if($errors->has('qtde')) has-error @endif ">
                                ...
                                <input type="number" class="form-control "   value="{{old('qtde',$perda->qtde)}}" placeholder="Qtde" name="qtde"   />
                                @if($errors->has('qtde'))
