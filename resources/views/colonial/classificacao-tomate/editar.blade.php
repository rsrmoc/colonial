<x-layout.colonial.layout>
    <div class="page-title">
        <h3>Editar Classificação de Tomate </h3>
    ...
    <div id="main-wrapper" x-data="app">
        <div class="col-md-12 ">
            <form action="{{ route('classificacaotomate-update', $tomate) }}" method="POST" class="panel panel-white">
                @csrf 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 ">
                            <div class="form-group @if($errors->has('total')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('total',str_replace('.', ',', $tomate->total) )}}" placeholder="Peso Total" x-mask:dynamic="$money($input, ',')"  name="total"> 
                                @if($errors->has('total'))
                    ...
                    <div class="row">
                        <div class="col-md-2  col-md-offset-1 ">
                            <div class="form-group @if($errors->has('residuo')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('residuo',str_replace('.', ',', $tomate->residuo) )}}" x-mask:dynamic="$money($input, ',')" placeholder="Residuo" name="residuo"> 
                        ...
                        <div class="col-md-2 ">
                            <div class="form-group @if($errors->has('terra')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('terra', str_replace('.', ',', $tomate->terra) )}}"  x-mask:dynamic="$money($input, ',')" placeholder="Terra" name="terra"> 
                                @if($errors->has('terra'))
                        ...
                        <div class="col-md-2 ">
                            <div class="form-group @if($errors->has('sujeira')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('sujeira',str_replace('.', ',', $tomate->sujeira) ) }}" x-mask:dynamic="$money($input, ',')" placeholder="Sujeira" name="sujeira"> 
                        ...
                        <div class="col-md-2 ">
                            <div class="form-group @if($errors->has('verde')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('verde',str_replace('.', ',', $tomate->verde) )}}" x-mask:dynamic="$money($input, ',')" placeholder="Verdes" name="verde"> 
                                @if($errors->has('verde'))
