 ...
 <?php 
				 echo '
					 ...
					 <tr>
						  ...
						  <th height="30" bgcolor="#E2E2E2">PRODUTO</th> 
						  <th height="30" bgcolor="#E2E2E2">DESCRIÇÃO</th> 
						  <th height="30" bgcolor="#E2E2E2">TIPO DE PERDA</th> 
				 ...
				 foreach ($DADOS as $val) { 
					 ...
					 <tr>
						...
						<td>'.mb_strtoupper($val->cd_produto).'</td> 
						<td>'.mb_strtoupper($val->nm_produto).'</td> 
						<td>'.mb_strtoupper($val->nm_tipo).'</td> 
						<td>'.number_format($val->qtde,0,",",".").'</td> 
						<td>'.mb_strtoupper($val->obs_perda).'</td> 
					 </tr>'; 
				 }
