    ...
    getDataChart1() { 
        ...
        axios.post('/colonial/prod_prev_real-json',this.parametros)
            .then((res) => {
                ...
                this.iconHeaderMoagemTotal = res.data.request.hidrico+'<span class="headerUnidade"> (Kg)</span>';
                this.iconHeaderMoagemTotalTb = res.data.request.AguaKg+'<span class="headerUnidade"> (Tb)</span>';
                this.iconHeaderMoagemEstoque = res.data.request.energia+'<span class="headerUnidade"> (Kg) </span>';
                this.iconHeaderMoagemEstoqueTb = res.data.request.EnergiaKg+'<span class="headerUnidade"> (Tb) </span>';
                this.iconHeaderMoagemConsumida = res.data.request.lenha+'<span class="headerUnidade"> (Kg) </span>';
                this.iconHeaderMoagemConsumidaTb = res.data.request.LenhaKg+'<span class="headerUnidade"> (Tb) </span>';

                
                this.iconHeaderTomateInNatura = res.data.request.LenhaKg+'<span class="headerUnidade">  </span>';
                this.iconHeaderBrix = res.data.request.LenhaKg+'<span class="headerUnidade">   </span>';
                this.iconHeaderBrixMedio = res.data.request.LenhaKg+'<span class="headerUnidade">   </span>';
                this.iconHeaderPerdas = res.data.request.LenhaKg+'<span class="headerUnidade">  </span>';
